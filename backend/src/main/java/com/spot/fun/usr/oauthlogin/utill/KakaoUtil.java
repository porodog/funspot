...
import com.spot.fun.usr.oauthlogin.exception.AuthHandler;
import com.spot.fun.usr.oauthlogin.exception.ErrorStatus;
...
public class KakaoUtil {
  ...
  public KakaoDTO.OAuthToken requestToken(String accessCode) {
    ...
    if (!response.getStatusCode().is2xxSuccessful()) {
      log.error("Failed to fetch token: " + response.getStatusCode());
      throw new RuntimeException("Failed to fetch token from Kakao");
    }
