...
const DateCourseListPage = () => {
  ...
  const navigateToAddCoursePage = () => {
    ...
    // } else {
    //   alert("로그인 후 코스를 추가할 수 있습니다."); // 로그인되지 않으면 경고 메시지
    // }
  };
  ...
  return (
    <BasicLayout>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        {Array.isArray(datecourses) && datecourses.length > 0 ? (
            ...
            <ul className="space-y-4">
              {datecourses.map((course) => (
                <li key={course.id} className="border-b pb-4">
                  ...
                  <p className="text-gray-700">{course.age_group}</p>
